...
<section
    ...
    <section class="flex flex-col w-full laptop:w-[50.5rem] px-10 py-12">
        ...
        <ul class="text-gray-400 space-y-4">
            ...
            <li class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 mt-2 mr-2" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path
            ...
            <li class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2" fill="none" viewBox="0 0 20 20"
                    stroke="currentColor">
                    <path
