        ...
        <main class="order-2 tablet:order-none flex-1">
            ...
            @else
                <div class="container tablet:mx-auto w-full">
                    ...
                    <div data-last_page="{{ $news_posts->lastPage() }}" data-url="{{ $baseUrl }}"
                        id="news-posts-container" class="grid grid-cols-1 gap-4">
            ...
            @if (Auth::check() and Auth::user()->is_admin)
                <div class="p-4">
                    ...
                    <div class="flex flex-wrap gap-2 mb-2 mt-1">
                        <span
                            class="bg-red-400 text-gray-800 px-3 py-1 ml-2 rounded-full text-sm ">{{ $user->status }}</span>
                    </div>
                </div>
            @endif
        </aside>
