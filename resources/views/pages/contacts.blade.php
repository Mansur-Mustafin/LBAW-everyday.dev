    ...
    <section class="flex flex-col w-full laptop:w-[50.5rem] px-10 py-12">
        ...
        <ul class="text-gray-400 space-y-4">
            <li class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-purple-500 mr-2" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3 10l4-4m0 0l4 4m-4-4v12m8-8h6M3 14h6m-6 4h6m4 0v4m0-4h2m-2-4h6m-6 0v4m0-4h2m-2 0h6m-6-8V4" />
                </svg>
                <strong class="mr-2">Phone:</strong> +351 936 827 450
            </li>
            <li class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-purple-500 mt-2 mr-2" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path
                        d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z" />
                </svg>
                <strong class="mr-2">Email:</strong> <a href="mailto:support@everyday.dev"
                    class="text-purple-500 hover:underline">support@everyday.dev</a>
            </li>
            <li class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-purple-500 mr-2" fill="none"
