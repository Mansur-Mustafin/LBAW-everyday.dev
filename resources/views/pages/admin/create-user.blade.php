...
<section
    ...
    <form method="POST" action="{{ url('/admin/register') }}" enctype="multipart/form-data"
        ...
        <div class="flex flex-col">
            <label class="font-bold text-sm mb-1">Public Name</label>
        ...
        <div class="flex flex-col">
            <label class="font-bold text-sm mb-1">Username</label>
        ...
        <div class="flex flex-col">
            <label class="font-bold text-sm mb-1">Email</label>
        ...
        <div class="flex flex-col">
            <label class="font-bold text-sm mb-1">Reputation</label>
        ...
        <div class="flex flex-col relative w-full">
            <label class="font-bold text-sm mb-1">Password</label>
