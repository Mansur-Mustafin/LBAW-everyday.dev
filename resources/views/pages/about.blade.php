...
<section
    ...
    <section class="flex flex-col w-full laptop:w-[50.5rem] px-10 py-12">
        ...
        <p class="mt-7 text-gray-400 leading-relaxed">
            <span class="font-bold">everyday.dev</span> is a community-driven platform designed to revolutionize how
            developers and tech enthusiasts share, discuss, and curate industry news. It will empower developers to stay
            updated with industry trends, enhance their skills, and streamline their learning.
        </p>
        ...
        <div class="flex flex-col gap-4 tablet:flex-row items-center space-between mt-5">
            ...
            <div class="flex flex-col items-center grow">
                <img src="{{ asset('assets/Goiana.jpg') }}" alt="Team Member 2"
                    class="w-20 h-20 rounded-full shadow-md mb-2">
                <p>
                    Diogo Goiana
                </p>
            ...
            <div class="flex flex-col items-center grow">
                <img src="{{ asset('assets/Mansur.jpg') }}" alt="Team Member 3"
                    class="w-20 h-20 rounded-full shadow-md mb-2">
                <p>
                    Mansur Mustafin
                </p>
            ...
            <div class="flex flex-col items-center grow">
                <img src="{{ asset('assets/Rubem.png') }}" alt="Team Member 4"
                    class="w-20 h-20 rounded-full shadow-md mb-2">
                <p>
                    Rubem Neto
                </p>
