<aside class="p-5 border-r border-solid border-gray-700 hidden laptop:h-full laptop:flex laptop:flex-col laptop:min-w-48">
    <a href="{{ route('admin.users') }}" class="block p-2 rounded-md hover:bg-gray-700 mt-4">Users</a>
    <a href="{{ route('admin.tags') }}" class="block p-2 rounded-md hover:bg-gray-700">Tags</a>
    <a href="{{ route('admin.tag_proposals') }}" class="block p-2 rounded-md hover:bg-gray-700">Tag Proposals</a>
    <a href="{{ route('admin.unblock_appeals') }}" class="block p-2 rounded-md hover:bg-gray-700">Unblock Appeals</a>
</aside>
