...
<section
    ...
    <form method="POST" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data"
        ...
        <div class="flex flex-col">
            ...
            <input name="email" class="disabled rounded-2xl bg-input outline-none p-3 text-sm" placeholder="Email*"
        ...
        @if (!is_null($user->password))
            <div class="flex flex-col relative w-full">
                ...
                <input name="old_password" type="password" class="rounded-2xl bg-input outline-none p-3 text-sm"
        ...
        <div class="flex flex-col relative w-full">
            ...
            <input name="new_password_confirmation" type="password"
                class="rounded-2xl bg-input outline-none p-3 text-sm" placeholder="Confirm Password*">
            <span class="toggle-password material-icons cursor-pointer absolute inset-y-9 right-3 text-gray-500">
                visibility_off
            </span>
