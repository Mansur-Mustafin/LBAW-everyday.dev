...
@section('content')
    <div class="container mx-auto flex flex-col gap-2 mt-4 laptop:m-auto laptop:max-w-[42.5rem]">
      ...
      <div class="flex text-black bg-white rounded p-2 mx-2 mt-4">
        ...
        <input data-url="{{ url('') }}" id="admin-search-bar" type="text" class="laptop:h-full laptop:p-2 outline-none rounded-t laptop:w-full text-lg laptop:text-xl">
      </div>

      <a href="{{url('admin/users/create')}}" 
        class="flex flex-col border text-white bg-black border-gray-700 rounded text-2xl items-center justify-center p-2 mx-2">
        <p class="w-fit">
          Create new user
        </p>
      </a>
