            ...
            <div class="vote-container mt-3 text-sm flex gap-2 items-center" data-type="comment"
                ...
                <button type="submit"
                    ...
                    <svg class="{{ $comment->user_vote == 'upvote' ? 'hidden' : '' }}"
                        id="comment-upvote-outline-{{ $comment->id }}" rpl="" fill="currentColor"
                        icon-name="upvote-outline" viewBox="0 0 20 20" width="20"
                    ...
                    <svg class="{{ $comment->user_vote == 'upvote' ? '' : 'hidden' }}"
                        id="comment-upvote-fill-{{ $comment->id }}" rpl="" fill="currentColor"
                        icon-name="upvote-fill" viewBox="0 0 20 20" width="20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <button type="submit"
                    ...
                    <svg class="{{ $comment->user_vote == 'downvote' ? 'hidden' : '' }}"
                        ...
                        icon-name="downvote-outline" viewBox="0 0 20 20" width="20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <svg class="{{ $comment->user_vote == 'downvote' ? '' : 'hidden' }}"
                        id="comment-downvote-fill-{{ $comment->id }}" rpl="" fill="currentColor"
                        icon-name="downvote-fill" viewBox="0 0 20 20" width="20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
