<div class="p-4 rounded shadow-sm flex flex-col justify-between">
    ...
    <div class="vote-container mr-4 flex items-center" data-type="post" data-id="{{ $news->id }}"
        ...
        <button type="submit" class="upvote-button flex items-center justify-center mr-1">
            ...
            <svg class="{{$news->user_vote == 'upvote' ? '' : 'hidden'}}" id="post-upvote-fill-{{ $news->id }}" rpl=""
                fill="currentColor" height="16" icon-name="upvote-fill" viewBox="0 0 20 20" width="16"
                xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <button type="submit" class="downvote-button flex items-center justify-center ml-1">
            ...
            <svg class="{{$news->user_vote == 'downvote' ? 'hidden' : ''}}" id="post-downvote-outline-{{ $news->id }}"
                rpl="" fill="currentColor" height="16" icon-name="downvote-outline" viewBox="0 0 20 20" width="16"
                xmlns="http://www.w3.org/2000/svg">
                <path
