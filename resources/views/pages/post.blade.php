...
<section class="flex w-full h-full laptop:m-auto laptop:max-w-[64rem]">
    <section class="flex flex-col w-full laptop:w-[42rem] px-10 py-12 border-x border-gray-700">
        ...
        <div
            class="flex border border-solid border-gray-700 rounded-xl mt-10 items-center justify-between pr-6 tablet:pr-14">
    ...
    <section
        class="hidden laptop:flex laptop:flex-col laptop:border-r laptop:p-4 laptop:border-gray-700 laptop:w-[20rem]">
        <input />
    </section>
</section>
@endsection