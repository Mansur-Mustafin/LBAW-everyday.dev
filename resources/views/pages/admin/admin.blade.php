...
<div
  ...
  <div class="flex gap-2 items-center mt-20 justify-between">
    <div class="flex flex-grow text-white bg-input rounded-2xl p-3">
  ...
  @if($show == 'tags')
    ...
    class="flex flex-col border border-gray-700 text-white bg-purple text-2xl items-center justify-center p-2 my-2">
    <p class="w-fit">
      Create new Tag
    </p>
    </a>
