...
@section('content')
    <div class="container mx-auto flex flex-col gap-2 mt-4">
      ...
      <a href="#" class="flex flex-col border text-white bg-black border-gray-700 rounded text-2xl items-center justify-center p-2">
        <p class="w-fit">
          Create new user
        </p>
      </a>
      ...
      <div class="flex flex-col border border-gray-700 rounded">
          <div class="flex justify-between p-2">
            ...
            <a class="flex flex-col p-2 justify-center" href="#">
