...
<section class="flex w-full h-full laptop:m-auto laptop:max-w-[64rem]">
    <section class="flex flex-col w-full laptop:w-[45rem] px-10 py-12 border-x border-gray-700">
        ...
        <p class="mt-7 text-gray-400 leading-relaxed">
            Everyday.dev is a platform dedicated to developers, providing a comprehensive suite of tools, resources, and learning opportunities to help you excel in your career. From daily coding challenges to in-depth tutorials, we are committed to making your journey as a developer productive and enjoyable.
        </p>
