...
<aside
    ...
    <div class="sticky top-[6rem] mt-3 laptop:flex laptop:flex-col laptop:gap-1">
        ...
        <a href="{{ route('admin.users') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 items-center {{ $page == 'users' ? 'bg-gray-800' : '' }} gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="{{ route('admin.tags') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 gap-2 items-center {{ $page == 'tags' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="{{ route('admin.tag_proposals') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 gap-2 items-center {{ $page == 'tag_proposals' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="{{ route('admin.unblock_appeals') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 gap-2 items-center {{ $page == 'unblock_appeals' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="{{ route('admin.omitted_posts') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 gap-2 items-center {{ $page == 'omitted_posts' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="{{ route('admin.omitted_comments') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 gap-2 items-center {{ $page == 'omitted_comments' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
<aside class="min-w-16 border-r border-solid border-gray-700 laptop:hidden h-full flex flex-col items-center gap-2">
    <div class="sticky top-[6rem] mt-3 laptop:flex laptop:flex-col laptop:items-center">
        ...
        <a href="{{ route('admin.users') }}"
            class="block p-2 rounded-md hover:bg-gray-700 {{ $page == 'users' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="lucide lucide-users">
                <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
        ...
        <a href="{{ route('admin.tags') }}"
            class="block p-2 rounded-md hover:bg-gray-700 {{ $page == 'tags' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="lucide lucide-tags">
                <path d="m15 5 6.3 6.3a2.4 2.4 0 0 1 0 3.4L17 19" />
        ...
        <a href="{{ route('admin.tag_proposals') }}"
            class="block p-2 rounded-md hover:bg-gray-700 {{ $page == 'tag_proposals' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="lucide lucide-hand-helping">
                <path d="M11 12h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 14" />
        ...
        <a href="{{ route('admin.unblock_appeals') }}"
            class="block p-2 rounded-md hover:bg-gray-700 {{ $page == 'unblock_appeals' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="lucide lucide-message-square-lock">
                <path d="M19 15v-2a2 2 0 1 0-4 0v2" />
        ...
        <a href="{{ route('admin.omitted_posts') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 gap-2 {{ $page == 'omitted_posts' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="lucide lucide-pencil-off">
                <path
        ...
        <a href="{{ route('admin.omitted_comments') }}"
            class="flex p-2 rounded-md hover:bg-gray-700 gap-2 {{ $page == 'omitted_comments' ? 'bg-gray-800' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="lucide lucide-message-circle-off">
                <path d="M20.5 14.9A9 9 0 0 0 9.1 3.5" />
