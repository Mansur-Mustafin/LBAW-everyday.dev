...
<section
    ...
    <form method="POST" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data"
        ...
        <fieldset>
            ...
            <h3 class="font-bold text-lg flex-1 my-4">User Information</h3>
            ...
            <div class="mt-4">
                ...
                <p class="text-sm text-gray-500">Leave the password fields empty if you do not wish to reset your
                    password.
                </p>
            </div>
            ...
            <div class="flex flex-col relative w-full mt-3">
            ...
            <div class="flex gap-2 justify-end my-4">
                <a href="{{ url('/users/' . $user->id . '/posts') }}"
                    class="text-input bg-white font-bold rounded-xl px-6 py-2">Cancel</a>
